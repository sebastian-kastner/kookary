...
export const RecipeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getRecipeCollection: async (page?: number, ingredients?: string, tags?: string, seasonal?: boolean, marked?: boolean, limit?: number, orderByRand?: boolean, name?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const RecipeApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getRecipeCollection(page?: number, ingredients?: string, tags?: string, seasonal?: boolean, marked?: boolean, limit?: number, orderByRand?: boolean, name?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2004>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getRecipeCollection(page, ingredients, tags, seasonal, marked, limit, orderByRand, name, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieves a Recipe resource.
...
export const RecipeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getRecipeCollection(page?: number, ingredients?: string, tags?: string, seasonal?: boolean, marked?: boolean, limit?: number, orderByRand?: boolean, name?: string, options?: any): AxiosPromise<InlineResponse2004> {
            return localVarFp.getRecipeCollection(page, ingredients, tags, seasonal, marked, limit, orderByRand, name, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves a Recipe resource.
         * @summary Retrieves a Recipe resource.
...
export class RecipeApi extends BaseAPI {
     ...
     * @memberof RecipeApi
     */
    public getRecipeCollection(page?: number, ingredients?: string, tags?: string, seasonal?: boolean, marked?: boolean, limit?: number, orderByRand?: boolean, name?: string, options?: AxiosRequestConfig) {
        return RecipeApiFp(this.configuration).getRecipeCollection(page, ingredients, tags, seasonal, marked, limit, orderByRand, name, options).then((request) => request(this.axios, this.basePath));
    }
