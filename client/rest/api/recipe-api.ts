...
export const RecipeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {'date' | 'rand' | 'name' | 'seasonality'} [orderBy] If set, results will be sorted by the given property (Default: date)
         ...
         * @throws {RequiredError}
         */
        getRecipeCollection: async (page?: number, ingredients?: string, tags?: string, seasonal?: boolean, marked?: boolean, orderBy?: 'date' | 'rand' | 'name' | 'seasonality', orderByDirection?: 'desc' | 'asc', author?: string, name?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const RecipeApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getRecipeCollection(page?: number, ingredients?: string, tags?: string, seasonal?: boolean, marked?: boolean, orderBy?: 'date' | 'rand' | 'name' | 'seasonality', orderByDirection?: 'desc' | 'asc', author?: string, name?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2004>> {
...
export const RecipeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getRecipeCollection(page?: number, ingredients?: string, tags?: string, seasonal?: boolean, marked?: boolean, orderBy?: 'date' | 'rand' | 'name' | 'seasonality', orderByDirection?: 'desc' | 'asc', author?: string, name?: string, options?: any): AxiosPromise<InlineResponse2004> {
...
export class RecipeApi extends BaseAPI {
     ...
     * @memberof RecipeApi
     */
    public getRecipeCollection(page?: number, ingredients?: string, tags?: string, seasonal?: boolean, marked?: boolean, orderBy?: 'date' | 'rand' | 'name' | 'seasonality', orderByDirection?: 'desc' | 'asc', author?: string, name?: string, options?: AxiosRequestConfig) {
