...
export const IngredientApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getIngredientCollection: async (page?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const IngredientApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getIngredientCollection(page?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse200>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getIngredientCollection(page, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieves a Ingredient resource.
...
export const IngredientApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getIngredientCollection(page?: number, options?: any): AxiosPromise<InlineResponse200> {
            return localVarFp.getIngredientCollection(page, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves a Ingredient resource.
         * @summary Retrieves a Ingredient resource.
...
export class IngredientApi extends BaseAPI {
     ...
     * @memberof IngredientApi
     */
    public getIngredientCollection(page?: number, options?: AxiosRequestConfig) {
        return IngredientApiFp(this.configuration).getIngredientCollection(page, options).then((request) => request(this.axios, this.basePath));
    }
