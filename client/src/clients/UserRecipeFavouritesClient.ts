...
export class UserRecipeFavouritesClient {
  ...
  public async getUserFavourite(
    ...
    return new Promise<number | null>((resolve, reject) => {
      this.client
        .getUserRecipeFavouritesCollection(
          userId.toString(),
          [],
          recipeId.toString(),
          []
  ...
  public async createUserFavourite(
    userId: number,
    recipeId: number
  ): Promise<null | number> {
    return new Promise<null | number>((resolve, reject) => {
      this.client
        .postUserRecipeFavouritesCollection({
  ...
  public async deleteUserFavourite(
    userRecipeFavouriteId: number
  ): Promise<void> {
    return new Promise<void>((resolve, reject) => {
      this.client
        .deleteUserRecipeFavouritesItem(userRecipeFavouriteId.toString())
        .then(() => resolve())
        .catch((e) => {
          logAxiosError(e);
          reject(e);
